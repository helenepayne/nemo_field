...
corolla_model <- lmer(corolla_diam_mm_SEG ~ (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
corolla_model_2 <- lmer(log(corolla_diam_mm_SEG) ~ Transect + (1 |Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
corolla_model_3 <- lmer((corolla_diam_mm_SEG_centered) ~ Transect + (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
# Create the mixed model for skeleton weight, with skeleton weight log transformed
skel_model <- lmer(log(skel_dryweight_mg_SEG) ~ (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
# Create the mixed model for skeleton weight, with skeleton weight log transformed
skel_model_2 <- lmer(log(skel_dryweight_mg_SEG) ~ Transect + (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
#Fit the model using the mean-centered variable
skel_model_3 <- lmer((skel_dryweight_mg_SEG_centered) ~ Transect + (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
fl_duration_model <- lmer(fl_duration ~ (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
est_fecundity_model <- lmer((est_fecundity) ~ (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
# Create the mixed model for estimated fecundity, sqrt transforming estimated fecundity
est_fecundity_model_2 <- lmer((est_fecundity) ~ Transect + (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
#Fit the model using the mean-centered variable
est_fecundity_model_3 <- lmer((est_fecundity_centered) ~ Transect + (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
msm_model <- lmer(log(msm_all) ~ (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
# Create the mixed model for mean seed mass, log transformed mean seed mass
msm_model_2 <- lmer(log(msm_all) ~ Transect + (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
#Fit the model using the mean-centered variable
msm_model_3 <- lmer((msm_centered) ~ Transect + (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
SLA_model <- lmer(log(SLA_SEG) ~ (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
##adding in transect##
# Create the mixed model for SLA
SLA_model_2 <- lmer(log(SLA_SEG) ~ Transect + (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
#Fit the model using the mean-centered variable
SLA_model_3 <- lmer((SLA_SEG_centered) ~ Transect + (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
```{r}
# Create the mixed model for mean seed mass, log transformed mean seed mass
LMA_model <- lmer(LMA_SEG ~ (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
d13C_model <- lmer(d13C_SEG ~ (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
# Create the mixed model for d13C, log transformed mean seed mass
d13C_model_2 <- lmer(d13C_SEG ~ Transect + (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
#Fit the model using the mean-centered variable
d13C_model_3 <- lmer((d13C_SEG_centered) ~ Transect + (1 | Donor: Recipient) + (1 | Donor), data = AC_23_fit)
...
est_fecundity_variances <- calculate_variances(est_fecundity_model_3, "estimated_fecundity")
msm_variances <- calculate_variances(msm_model, "mean_seed_mass")
SLA_variances <- calculate_variances(SLA_model_2, "SLA")
corolla_variances <- calculate_variances(corolla_model_2, "corolla_diameter")


# Combine the results into a single dataframe
variance_AC_2023_G1 <- rbind(
  skel_variances,
  d13C_variances,
...
write_csv(x = variance_AC_2023_G1, here::here("data_sheets", "compiled_sheets", "AC_Va_h2_R_2023.csv"))
