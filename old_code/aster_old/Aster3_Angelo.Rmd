...
AC_22$mean_seeds_per_fruit[is.na(AC_22$mean_seeds_per_fruit)]<-0
...
subset(AC_22, mean_seeds_per_fruit > 0 & surv_to_flower == 0)
subset(AC_22, mean_seeds_per_fruit > 0 & any_FitP == 0)
subset(AC_22, mean_seeds_per_fruit > 0 & total_fruits == 0)
subset(AC_22, mean_seeds_per_fruit > 0 & closed_fruits == 0)
...
#adding new rows for each fruit so that we can include 2 subsets
```{r}
...
expanded_AC_22 <- expand_rows(AC_22)
...
expanded_AC_22 <- as.data.frame(expanded_AC_22)
...
AC22_aster <- reshape(expanded_AC_22 ,varying = list(vars), direction = "long", timevar = "varb",times = as.factor(vars), v.names = "resp")

#####Check that the reshape worked 
#If it did the number of rows will be the same 
nrow(AC22_aster)
nrow(expanded_AC_22)*length(vars)


#####Designate fitness variable, "mean_seeds_per_fruit", which is the final node 
#grep1 is like a search function
fit<-grepl("mean_seeds_per_fruit", as.character(AC22_aster$varb))
fit<-as.numeric(fit)
AC22_aster$fit<-fit
...
hist(AC22_flwr$mean_seeds_per_fruit)

#get parameters for a negative binomial distribution
AC22.param <- fitdistr(AC22_flwr$mean_seeds_per_fruit, "negative binomial")
...
#nbinomial??
hist(rnbinom(2356, size = 0.00987, mu=0.02743))
hist(rpois(2356, lambda=0.02743))

#evaluate filled seeds node. Proceed as outlined above 
#poisson is better
AC22_total_fruit<-subset(AC_22, total_fruits>0)
hist(AC22_total_fruit$mean_seeds_per_fruit)
AC22.param2 <- fitdistr(AC22_total_fruit$mean_seeds_per_fruit, "negative binomial") 

hist(rnbinom(424, size = 49.02, mu=2.29))
hist(rpois(424, lambda=2.29))


#evaluate filled seeds node. Proceed as outlined above 
#poisson is better
AC22_closed_fruit<-subset(AC_22, closed_fruits>0)
hist(AC22_closed_fruit$mean_seeds_per_fruit)
AC22.param3 <- fitdistr(AC22_closed_fruit$mean_seeds_per_fruit, "negative binomial") 

hist(rnbinom(408, size = 340.54, mu=2.28))
hist(rpois(408, lambda=2.28))
```
...
#(Intercept)        -21.013682   0.079540 -264.192  < 2e-16 ***
#fit                 18.777881   0.092303  203.437  < 2e-16 ***
#varbclosed_fruits   22.264377   0.097445  228.481  < 2e-16 ***
#varbsurv_to_flower  22.514893   0.095201  236.498  < 2e-16 ***
#varbtotal_fruits    25.001827   0.082253  303.961  < 2e-16 ***
#fit:Transect2       -0.206238   0.035486   -5.812 6.18e-09 ***
#fit:Transect3       -0.262563   0.033838   -7.759 8.53e-15 ***
#fit:Transect4       -0.061090   0.027939   -2.187   0.0288 *  
#fit:Transect5       -0.273749   0.030730   -8.908  < 2e-16 ***
#fit:Transect6       -0.001988   0.031044   -0.064   0.9489    
#fit:Transect7       -0.223274   0.029209   -7.644 2.11e-14 ***
#fit:Transect8       -0.196769   0.038656   -5.090 3.58e-07 ***
#fit:Transect9       -0.344531   0.032913  -10.468  < 2e-16 ***
#---
#Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

#Square Roots of Variance Components (P-values are one-tailed):
#          Estimate Std. Error z value Pr(>|z|)/2    
#Donor      0.18400    0.04258   4.321   7.75e-06 ***
#Recipient  0.27962    0.02919   9.580    < 2e-16 ***
#---
#Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
#Fixed Effects:
#                          Estimate Std. Error z value Pr(>|z|)    
#(Intercept)              -21.04604    0.07956  -264.5   <2e-16 ***
#varbclosed_fruits         22.29674    0.09746   228.8   <2e-16 ***
#varbmean_seeds_per_fruit  18.66159    0.09079   205.5   <2e-16 ***
#varbsurv_to_flower        22.54726    0.09521   236.8   <2e-16 ***
#varbtotal_fruits          25.03408    0.08227   304.3   <2e-16 ***
#---
#Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

#Square Roots of Variance Components (P-values are one-tailed):
#          Estimate Std. Error z value Pr(>|z|)/2    
#Donor      0.18345    0.04150   4.421   4.92e-06 ***
#Recipient  0.27559    0.02854   9.655    < 2e-16 ***
#---
#Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
#1          5           2  345436                                   
#2         13           2  345692      8       0   255.71 1.0584e-50
...
#Fixed Effects:
#                    Estimate Std. Error  z value Pr(>|z|)    
#(Intercept)        -21.08735    0.07950 -265.260  < 2e-16 ***
#fit                 18.94110    0.08927  212.167  < 2e-16 ***
#varbclosed_fruits   22.33804    0.09741  229.318  < 2e-16 ***
#varbsurv_to_flower  22.58856    0.09517  237.361  < 2e-16 ***
#varbtotal_fruits    25.07533    0.08221  305.003  < 2e-16 ***
#fit:Transect2       -0.18421    0.02943   -6.259 3.88e-10 ***
#fit:Transect3       -0.30560    0.02901  -10.535  < 2e-16 ***
#fit:Transect4       -0.08589    0.02254   -3.810 0.000139 ***
#fit:Transect5       -0.30095    0.02615  -11.510  < 2e-16 ***
#fit:Transect6       -0.01503    0.02567   -0.586 0.558113    
#fit:Transect7       -0.24431    0.02645   -9.235  < 2e-16 ***
#fit:Transect8       -0.23829    0.03434   -6.940 3.92e-12 ***
#fit:Transect9       -0.33876    0.02895  -11.703  < 2e-16 ***
---
#Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

#Square Roots of Variance Components (P-values are one-tailed):
#      Estimate Std. Error z value Pr(>|z|)/2    
#Donor  0.22585    0.02711    8.33     <2e-16 ***
#---
#Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
#varbmean_seeds_per_fruit    18.3937     0.2156   85.32   <2e-16 ***
...
#Fixed Effects:
#                    Estimate Std. Error z value Pr(>|z|)    
#(Intercept)        -21.04633    0.07955  -264.6   <2e-16 ***
#fit                 18.66019    0.09400   198.5   <2e-16 ***
#varbclosed_fruits   22.29703    0.09746   228.8   <2e-16 ***
#varbsurv_to_flower  22.54754    0.09521   236.8   <2e-16 ***
#varbtotal_fruits    25.03437    0.08227   304.3   <2e-16 ***
#---
#Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

#Square Roots of Variance Components (P-values are one-tailed):
#         Estimate Std. Error z value Pr(>|z|)/2    
#Parental  0.24958    0.02086   11.97     <2e-16 ***
#---
#Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
map.too <- map.factory.too(rout_AC22_2, vars %in% c("any_FitP", "closed_fruits"))
...
AC_23 <- read_csv(here::here("data_sheets", "compiled_sheets", "AC_mastersheet_full_2023.csv")) %>%
  dplyr::select("Transect", "Gen", "Donor", "Recipient", "sample_ID_SEG", "surv_to_flower", "F_plant", "total_fruits", "closed_fruits", "mean_seeds_per_fruit", "msm_all") %>%
...
AC_23[is.na(AC_23$mean_seeds_per_fruit),]$mean_seeds_per_fruit <- 0
AC_23[is.na(AC_23$F_plant),]$F_plant <- 0

####check for nonsense data
subset(AC_23, mean_seeds_per_fruit > 0 & surv_to_flower  == 0)
subset(AC_23, mean_seeds_per_fruit > 0 & total_fruits == 0)
subset(AC_23, mean_seeds_per_fruit > 0 & closed_fruits ==0)
subset(AC_23, mean_seeds_per_fruit > 0 & mean_seeds_per_fruit ==0)
...
AC_23$mean_seeds_per_fruit[AC_23$surv_to_flower == 0] <- 0
...
AC_23$mean_seeds_per_fruit[AC_23$total_fruits == 0] <- 0
...
AC_23$mean_seeds_per_fruit[AC_23$closed_fruits == 0] <- 0
```
...
seedWgt_AC <- AC_23 %>%
  dplyr::select(sample_ID_SEG, Recipient, Gen, surv_to_flower, msm_all, mean_seeds_per_fruit) %>%
...
hist(ACyr2_cl_fruits$mean_seeds_per_fruit)
AC2.param3 <- fitdistr(ACyr2_cl_fruits$mean_seeds_per_fruit, "negative binomial") 
...
fit<-grepl("mean_seeds_per_fruit", as.character(AC23_aster$varb))
fit<-as.numeric(fit)
AC23_aster$fit<-fit
...
#varbmean_seeds_per_fruit   -0.663190   0.045771 -14.489  < 2e-16 ***
...
map <- map.factory(rout_AC23, vars %in% c("F_plant", "closed_fruits"))
...
map.too <- map.factory.too(rout_AC23, vars %in% c("F_plant", "closed_fruits"))
...
hist(ACyr2_cl_fruits_b$mean_seeds_per_fruit)
AC2b.prog.param3 <- fitdistr(ACyr2_cl_fruits_b$mean_seeds_per_fruit, "negative binomial") 
...
fit<-grepl("mean_seeds_per_fruit", as.character(AC23_aster_g2$varb))
fit<-as.numeric(fit)
