...
map <- map.factory(rout_BB22, vars %in% c("any_FitP", "closed_fruits"))
...
map.too <- map.factory.too(rout_BB22, vars %in% c("any_FitP", "closed_fruits"))
...
map <- map.factory(rout_BB23, vars %in% c("F_plant", "closed_fruits"))
...
map.too <- map.factory.too(rout_BB23, vars %in% c("F_plant", "closed_fruits"))
...
```{r}
correlation <- cor(BB_22$total_fruits, BB_22$filled_seeds, use = "complete.obs")
print(correlation)

correlation <- cor(BB_23$total_fruits, BB_23$filled_seeds, use = "complete.obs")
print(correlation)
```