...
```{r}
correlation <- cor(AC_22$total_fruits, AC_22$filled_seeds, use = "complete.obs")
print(correlation)

correlation <- cor(AC_23$total_fruits, AC_23$filled_seeds, use = "complete.obs")
print(correlation)
```