...
BO_merged_1 <- merge(BO_flowering, skel_weights_BO, by = c("Transect", "SegPos", "Gen", "Recipient", "Plant_ID"), all.x = TRUE)  %>% select(-c(Fitness, FD_01:FD_05, LeafD, FLR_P, Skeleton, Notes)) %>% arrange(Transect, Sequence, SegPos)
