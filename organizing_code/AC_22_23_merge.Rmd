...
```{r}
#We want to add the skel weights for 2022 to skel_dryweight_mg_SEG
...
AC_22_23_fit <- AC_22_23_fit %>%
  mutate(skel_dryweights_mg_SEG = if_else(
    is.na(skel_dryweights_mg_SEG), 
    skel_dryweight_mg, 
    skel_dryweights_mg_SEG))

# Replace the value 895.47 with NA in skel_dryweight_mg and skel_dryweight_mg_SEG
AC_22_23_fit <- AC_22_23_fit %>%
  mutate(skel_dryweights_mg = if_else(skel_dryweight_mg == 895.47, NA_real_, skel_dryweight_mg),
         skel_dryweights_mg_SEG = if_else(skel_dryweights_mg_SEG == 895.47, NA_real_, skel_dryweights_mg_SEG))
